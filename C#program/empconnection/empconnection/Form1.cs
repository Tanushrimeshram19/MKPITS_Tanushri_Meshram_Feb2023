...
namespace empconnection
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                label8.Text = EmployeeDetails.InsertEmployeedata(Convert.ToInt32(textBox1.Text), textBox2.Text, radioButton1.Text, textBox3.Text, Convert.ToInt32(textBox4.Text), comboBox1.Text, Convert.ToDateTime(dateTimePicker1.Text));
            }
